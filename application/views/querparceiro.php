    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center text-white">
                <h2 class="section-heading title_color_diego_blue">Quer ser nosso parceiro?</h2>
                <br/>
            </div>
            <div class="col-md-12">
                <p>
...
<section id="backgroung_section_blue">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading title_color_diego_orange">Patrocine uma das modalidades</h2>
                <br/>
            </div>
            <div class="col-md-4">
...
<section>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center text-white">
                <h2 class="section-heading title_color_diego_blue">Esteja na nossa feira de empresas</h2>
                <br/>
            </div>
