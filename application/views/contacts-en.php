        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center text-black">
                    <h2 class="section-heading-diego">Contacts</h2>
                    <br/>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member2">
                        ...
                        <h4>João Valente</h4>
                        <p class="text-muted">Coordinator of EBEC Challenge Aveiro</p>
                        <p>
                ...
                <div class="col-sm-4">
                    <div class="team-member2">
                        ...
                        <p class="text-muted">President of BEST Aveiro</p>
                        <p>
                ...
                <div class="col-sm-4">
                    <div class="team-member2">
                        ...
                        <h4>Joana Caneco</h4>
                        <p class="text-muted">Treasurer of BEST Aveiro</p>
                        <p>
                ...
                <div class="col-sm-4">
                    <div class="team-member2">
                        ...
                        <p class="text-muted">Responsible for Business Relations</p>
                        <p>
                            <i class="fa fa-envelope"></i><a href="mailto:catarina.lopes@BEST.eu.org"> catarinavslopes5@BEST.eu.org </a><br/>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center team-member">
                    <h4 class="title_color_diego_orange"><i class="fa fa-home" style="color:color:#EEA225"></i> Address</h4>
                    ...
                    <h4  class="title_color_diego_orange"><i class="fa fa-phone" style="color:color:#EEA225"></i> Phone</h4>
                    <p class="text-muted text-white">
                        +351 925 030 168
                    </p>
                    <h4  class="title_color_diego_orange"><i class="fa fa-envelope" style="color:color:#EEA225"></i> E-mail</h4>
                    <p class="text-muted text-white">
                    ...
                    <ul class="list-inline">
                        ...
                        <li>
                            <a href="https://www.facebook.com/EBEC.aveiro/"target="_blank">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x" style="color:#EEA225"></i>
