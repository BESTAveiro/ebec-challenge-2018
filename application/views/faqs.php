<section id="backgroung_section_orange" style="height:120px">
    <div class="row">
        ...
        <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted text-muted-diego" style="margin-bottom:-30px">Frequently Asked Questions</h3>
        </div>
    </div>
</section>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse1" class="panel-collapse collapse">
                        <div class="panel-body">
                            Tens 24 horas para construir o teu protótipo, caso participes no <i>Team Design</i>, ou arranjar uma solução para o problema de
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title text-no-transform title_color_diego_blue">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                                Há quantos membros por equipa?
                            </a>
                        </h4>
                    </div>
                    <div id="collapse2" class="panel-collapse collapse">
                        <div class="panel-body">
                            Cada equipa é constituída <u>sempre</u> por 4 elementos.
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
